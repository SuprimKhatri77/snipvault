  ...
  const displaySnippets =
    activeFilter === "all"
      ...
      : filteredSnippets.filter(
          (snippet) => snippet.visibility === activeFilter.toUpperCase()
        );
    ...
    <div className="relative bg-[#0F172A] text-gray-100 max-w-[1600px] mx-auto w-full">
      ...
      <div className="flex flex-col lg:flex-row relative">
            ...
            <div className="flex flex-col h-full">
              ...
              <nav className="mt-2 px-3 flex-1">
                <div className="space-y-1">
                  <button
                    className={`group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg w-full ${
                      activeFilter === "all"
        ...
        <div className="lg:flex-1">
          {/* Top Navigation */}
          <div className="sticky top-16 z-20 flex h-16 flex-shrink-0 bg-[#1E293B] shadow-md">
            ...
            <div className="mb-8">
              ...
              <div className="mt-2 flex items-center">
                <span className="text-xs text-gray-400">
                  {usageStats.currentCount} of {usageStats.maxCount} snippets
                  used on your {usageStats.plan} plan
                </span>
                  ...
                  >
                    ...
                    <div className="p-4 flex items-start justify-between">
                      <div className="flex items-start space-x-3">
                        <div
                          className={`flex-shrink-0 p-2 rounded-md ${getLanguageIcon(
                            snippet.title
                          )}`}
                        >
                    ...
                    <div className="px-4 py-3 bg-[#1A2234] border-t border-[#334155]">
                      <div className="flex sm:flex-row sm:items-center gap-2">
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0 sm:ml-auto">
                          <button
                            onClick={() =>
                              copyToClipboard(snippet.snippet, snippet.id)
                            }
                            className={`cursor-pointer px-2 py-1.5 rounded-md flex items-center text-xs font-medium transition-colors ${
                              copied === snippet.id
